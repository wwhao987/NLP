...
import utils
from models.classify_model import SeqClassifyModule
from models.classify_model._base import OutputFCModule
...
class CRFSeqClassifyModule(SeqClassifyModule):
    ...
    def __init__(self, param: utils.Params):
        super(CRFSeqClassifyModule, self).__init__(param=param)
        ...
        # crf模块
        self.crf = CRFLayer(tag2idx=self.param.tag2idx)
...
if __name__ == '__main__':
    params = utils.Params(config=BertConfig.from_dict({}))
    l = CRFLayer(tag2idx=params.tag2idx)

    featss = torch.rand(10, 2, 27)
    masks = torch.randint(0, 2, (10, 2))
    r1 = l(featss, masks)
    print(r1)
    r2 = l.viterbi_decode(featss, masks)
    print(r2)
