...
class RTransformerEncoderModule(EncoderModule):
    def __init__(self, param):
        super(RTransformerEncoderModule, self).__init__(param=param)
        self.proxy = RTransformer(
            tag_size=self.param.num_labels,
            dropout=self.param.encoder_rtrans_dropout,
            d_model=self.param.config.hidden_size,
            rnn_type='GRU',
