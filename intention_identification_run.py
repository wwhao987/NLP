...
from intention_identification.actuator import Trainer, Evaluator, Predictor


def training_model():
    trainer = Trainer(
        token_vocab_file="intention_identification/datas/output/vocab.pkl",
        label_vocab_file="intention_identification/datas/output/label_vocab.pkl",
        output_dir="intention_identification/datas/output/v2"
    )
    cfg = {
        'token_emb_layer': {
    ...
    trainer.training(
        cfg,
        data_files='intention_identification/datas/original/train.csv',
        n_epochs=1000,
        batch_size=16,
        eval_ratio=0.1,
...
def eval_model():
    ...
    evaluator = Evaluator(
        ...
        token_vocab_file="intention_identification/datas/output/vocab.pkl",
        label_vocab_file="intention_identification/datas/output/label_vocab.pkl",
        output_dir="intention_identification/datas/output/v1"
    )
    evaluator.eval(
        data_files='intention_identification/datas/original/train.csv',
        batch_size=16,
...
def predictor_model():
    predictor = Predictor(
        ckpt_path=r"intention_identification\datas\output\v1\models\model_000070.pkl",
        token_vocab_file="intention_identification/datas/output/vocab.pkl",
        label_vocab_file="intention_identification/datas/output/label_vocab.pkl",
    )
    ...
    # with open("intention_identification/datas/original/test.csv", 'r', encoding='utf-8') as reader:
    #     with open("intention_identification/datas/output/v1/eval/test.csv", "w", encoding='utf-8') as writer:
